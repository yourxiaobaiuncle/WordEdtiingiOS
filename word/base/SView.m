...
-(void)drawRect:(CGRect)rect{
    ...
    [mutableAttributedString addAttribute:NSFontAttributeName value:[UIFont fontWithName:self.fontFimaly size:self.wordFont] range:NSMakeRange(0, mutableAttributedString.length)];
