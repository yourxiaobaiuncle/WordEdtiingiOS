...
-(UICollectionView *)myCollectionView{
    if (!_myCollectionView) {
        ...
        _myCollectionView=[[UICollectionView alloc] initWithFrame:CGRectMake(0, 427*XHSizeW, XHScreenW, 75*XHSizeH) collectionViewLayout:flowLayout];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    UIImageView *imageView=[[UIImageView alloc] initWithFrame:CGRectMake(10*XHSizeW, 20*XHSizeH, 35*XHSizeW, 35*XHSizeW)];
